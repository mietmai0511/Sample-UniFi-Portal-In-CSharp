...
namespace UnfiConnect
{
    ...
    internal static class HttpUtility
    {
        ...
        public static string PostRequestIsSync(Uri url, string postData, CookieContainer cookieContainer, int timeout = 60000)
        {
            // Construct the POST request
            var request = (HttpWebRequest)WebRequest.Create(url);
            request.Method = "POST";
            ...
            {
                // Write the POST data to the request stream
                postDataStream.Write(postDataByteArray, 0, postDataByteArray.Length);
        ...
        public static string AuthenticateViaJsonPostMethodIsSync(Uri url, string username, string password, CookieContainer cookieContainer, int timeout = 60000)
        {
            // Construct the POST request which performs the login
            var request = (HttpWebRequest)WebRequest.Create(url);
            request.Method = "POST";
        ...
        public  static string LogoutViaJsonPostMethodIsSync(Uri url, CookieContainer cookieContainer, int timeout = 60000)
        {
            // Construct the POST request which performs the login
            var request = (HttpWebRequest)WebRequest.Create(url);
            request.Method = "POST";
